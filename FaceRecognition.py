...
#It contains all common functions that are called in tester.py file


#It returns rectangle for face detected alongwith gray scale image
def faceDetection(test_img):
    gray_img=cv2.cvtColor(test_img,cv2.COLOR_BGR2GRAY)#convert color image to grayscale
    face_haar_cascade=cv2.CascadeClassifier('C:\\Users\\HP\\Desktop\\ML\\Face Detection\\HaarCascade\\haarcascade_frontalface_default.xml')#Load haar classifier
...
#This function draws boxes around detected face in an image
...
def put_text(test_img,text,x,y):
    cv2.putText(test_img,text,(x-30,y-20),cv2.FONT_HERSHEY_DUPLEX,1,(255,0,0),1)